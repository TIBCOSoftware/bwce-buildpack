...
##Buildpack Extension
You can customize the buildpack to use supported third-party drivers e.g. Oracle JDBC driver or OSGified bundles in TIBCO BusinessWorks™ Container Edition runtime. You can also customize buildpack to store application certificates and to integrate with application configuration management services.
...
*  **Provision TIBCO BusinessWorks™ Container Edition Plug-ins**: The TIBCO BusinessWorks™ Container Edition 1.0.1 release has added support for certified plug-ins. Contact `TIBCO Support` for list of all supported Plug-ins. 
  To customize your buildpack for plug-in(s):
